 ...
 *     -e POSTGRES_DB=agentvault -p 5440:5432 postgres:16-alpine
 *   DATABASE_URL="postgresql://postgres:postgres@localhost:5440/agentvault" \
 *     pnpm --filter @agentvault/db prisma migrate deploy
 *   POLICY_PROOF_DATABASE_URL="postgresql://postgres:postgres@localhost:5440/agentvault" \
 *     pnpm --filter @agentvault/api test -- --run src/ee/services/policy-oss-cutover.pg.test.ts
 *
...
// Dynamic imports throughout: @agentvault/db builds its client from DATABASE_URL
