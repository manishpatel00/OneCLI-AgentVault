import { db, Prisma } from "@agentvault/db";
...
export const assertIdentitiesValid = async (
  ...
  // is there (directory identities are a AgentVault Cloud capability); the EE
  ...
  if (
    ...
    throw new ServiceError(
      "UNPROCESSABLE",
      isOssEdition()
        ? "Group and user identities are available on AgentVault Cloud."
 ...
 * (granular scoping is a AgentVault Cloud capability — step 9.5). A no-op for
