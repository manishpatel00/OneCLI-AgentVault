...
//! the `aws-sigv4` crate. Credentials are delivered via `x-agentvault-aws-*`
...
const AWS_ACCESS_KEY_HEADER: &str = "x-agentvault-aws-access-key-id";
const AWS_SECRET_KEY_HEADER: &str = "x-agentvault-aws-secret-access-key";
const AWS_SESSION_TOKEN_HEADER: &str = "x-agentvault-aws-session-token";
const AWS_REGION_HEADER: &str = "x-agentvault-aws-region";
