    ...
    AppProvider {
        ...
        credential_headers: &[
            CredentialHeader {
                ...
                header_name: "x-agentvault-aws-access-key-id",
            },
            CredentialHeader {
                credential_field: "secretAccessKey",
                header_name: "x-agentvault-aws-secret-access-key",
            },
            CredentialHeader {
                credential_field: "region",
                header_name: "x-agentvault-aws-region",
            },
        ],
        credential_params: &[],
        host_rewrite: None,
...
pub(crate) async fn refresh_github_app_token(
    ...
    let mut req = reqwest::Client::new()
        ...
        .header("User-Agent", "agentvault-gateway");
...
mod tests {
    ...
    fn google_search_console_path_disambiguation() {
        let result = provider_for_host_and_path(
            "www.googleapis.com",
            "/webmasters/v3/sites/sc-domain:agentvault.sh/searchAnalytics/query",
        );
        assert_eq!(
            result,
    ...
    fn aws_credential_headers_defined() {
        ...
        assert_eq!(headers[0].header_name, "x-agentvault-aws-access-key-id");
        assert_eq!(headers[1].credential_field, "secretAccessKey");
        assert_eq!(headers[1].header_name, "x-agentvault-aws-secret-access-key");
        assert_eq!(headers[2].credential_field, "region");
        assert_eq!(headers[2].header_name, "x-agentvault-aws-region");
    }
