...
/// Resolve the summarizer for a AgentVault provider id. OSS providers match here;
...
///
/// `provider` is the AgentVault provider id (from `apps::provider_for_host_and_path`);
