...
import {
  ...
  AccordionItem,
  AccordionTrigger,
} from "@agentvault/ui/components/accordion";
...
import type { CreateSecretInput } from "@agentvault/api/validations/secret";
...
import { validateDisplayName } from "@agentvault/api/validations/display-name";
import {
                  ...
                  <p className="text-muted-foreground text-xs">
                    {openaiMode === "api-key" ? (
                      <>
                        ...
                        .{" "}
                        <a
                          href="https://agentvault.sh/docs/integrations/openai#setup-api-key"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-foreground underline underline-offset-2"
                        >
                      ...
                      <>
                        ...
                        <a
                          href="https://agentvault.sh/docs/integrations/openai#setup-codex-oauth"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-foreground underline underline-offset-2"
                        >
