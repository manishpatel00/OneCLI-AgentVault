...
export const GetStartedDialog = ({
  ...
  const buildCurlCommand = (path: string) => {
    ...
    if (installInfo.appUrl !== "https://app.agentvault.sh") {
  ...
  const runCommand = `agentvault run -- ${activeAgentDef.runAlias}`;
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="gap-0 p-0 sm:max-w-xl">
        <DialogHeader className="p-6 pb-4">
          ...
          <DialogDescription>
            Choose how you want to use AgentVault.
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="px-6 pb-6">
            ...
            <div className="grid grid-cols-2 gap-2">
              <SectionCard
                icon={Bot}
                title="Coding Agents"
                description="Connect a coding agent to AgentVault"
              ...
              <SectionCard
                ...
                description="Connect an autonomous agent to AgentVault"
                ...
                <div className="space-y-3">
                  ...
                  {cliInstallCommand ? (
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        <p className="text-muted-foreground text-xs">
                          ...
                          Run {activeAgentDef.name} through AgentVault:
                        </p>
                    ...
                    <div className="space-y-3">
                      ...
                      <p className="text-muted-foreground text-xs">
                        Requires the AgentVault CLI. One-command install is
                        available with{" "}
                        <a
              ...
              {activeSection === "autonomous" && (
                <div className="space-y-3">
                  {IS_CLOUD && migrateCommand ? (
                    <>
                      <p className="text-muted-foreground text-xs">
                        Already running NanoClaw? Migrate to AgentVault cloud:
                      </p>
