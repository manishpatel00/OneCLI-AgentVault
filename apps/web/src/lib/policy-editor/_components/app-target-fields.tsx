...
import { Checkbox } from "@agentvault/ui/components/checkbox";
import {
  Select,
  SelectContent,
  SelectItem,
...
import { getApp } from "@agentvault/api/apps/registry";
...
// module is a locked "available on AgentVault Cloud" hint. Alias key on purpose —
